...
if(test == true){
    if(n <= 280.00) {
        ul.innerHTML = 
            `
                <li class='negrito'>Salário antes do reajuste: <span style="color:green">R$ ${valor}</span>;</li>
                <li>Percentual de aumento aplicado: <span style="color:green">20%</span></span>;</li>
                <li>Valor do aumento: <span style="color:green">R$ ${valorAumento1}</span>;</li>
                <li>Novo salário, após o aumento: <span style="color:green">R$ ${novoValor1}</span>.</li>
            `
    }else if(n <= 700.00){
        ul.innerHTML = 
            `
                <li>Salário antes do reajuste: <span style="color:green">R$ ${valor}</span>;</li>
                <li>Percentual de aumento aplicado: <span style="color:green">15%</span>;</li>
                <li>Valor do aumento: <span style="color:green">R$ ${valorAumento2}</span>;</li>
                <li>Novo salário, após o aumento: <span style="color:green">R$ ${novoValor2}</span>.</li>
            `
    }else if(n <= 1500.00){
        ul.innerHTML = 
            `
                <li>Salário antes do reajuste: <span style="color:green">R$ ${valor}</span>;</li>
                <li>Percentual de aumento aplicado: <span style="color:green">10%</span>;</li>
                <li>Valor do aumento: <span style="color:green">R$ ${valorAumento3}</span>;</li>
                <li>Novo salário, após o aumento: <span style="color:green">R$ ${novoValor3}</span>.</li>
            `
    }else if(n > 1500.00){
        ul.innerHTML = 
            `
                <li>Salário antes do reajuste: <span style="color:green">R$ ${valor}</span>;</li>
                <li>Percentual de aumento aplicado: <span style="color:green">5%</span>;</li>
                <li>Valor do aumento: <span style="color:green">R$ ${valorAumento4}</span>;</li>
                <li>Novo salário, após o aumento: <span style="color:green">R$ ${novoValor4}</span>.</li>
            `
    }
}else {
